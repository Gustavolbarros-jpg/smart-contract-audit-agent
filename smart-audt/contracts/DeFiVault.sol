    ...
    contract DeFiVault {
        ...
        // ─── Modifiers ─────────────────────────────────────────
        modifier onlyOwner() {
            require(tx.origin == owner, "not owner"); // VULN: tx.origin
            _;
        }
        ...
        function withdraw(uint256 amount) external notPaused onlyWhitelisted {
            ...
            // VULN: estado atualizado depois da call externa
            balances[msg.sender] -= amount;
            totalDeposits        -= amount;
            lastWithdraw[msg.sender] = block.timestamp;

            // VULN: maxWithdraw verificado depois que o dinheiro já saiu
        ...
        function claimReward() external notPaused onlyWhitelisted {
            ...
            // VULN: estado atualizado depois da call
        ...
        function transferOwnership(address newOwner) external onlyOwner {
            pendingOwner = newOwner; // VULN: aceita address(0)
        }
        ...
        function emergencyWithdraw(address payable to, uint256 amount) external onlyOwner {
            ...
            to.transfer(amount); // VULN: to não validado
        }
